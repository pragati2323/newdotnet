...
<body>
    <form id="form1" runat="server">     <div id="header">
		...
		<ul class="menu" style="width: 784px">
			...
			<li><a href="Download.aspx"><img src="images/but3.jpg" alt="" width="130" height="36" /></a></li>
			<li><a href="Howtobuy.aspx"><img src="images/but4.jpg" alt="" width="130" height="36" id="IMG1" onclick="return IMG1_onclick()" /></a></li>
			<li><a href="#"><img src="images/but5.jpg" alt="" width="130" height="36" /></a></li>
			<li><a href="#"><img src="images/butclean.jpg" alt="" width="111" height="36" /></li>
		</ul>
	</div>
