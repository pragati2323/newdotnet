...
Partial Class Batteries
    ...
    Public Sub data(ByVal num As Integer)
        ...
        sql = "select top 8 * from item where code Not in(select top(" & num & ") code from item where category='Batteries' order by code)and category='Batteries' order by code"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        conn.Open()
        Dim sql = "select count(*) from item where category='Batteries'"
    ...
    Protected Sub lnk1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk1.Click
        Session("line") = 0
        Response.Redirect("Batteries.aspx")
        ' Session.Remove("line")
