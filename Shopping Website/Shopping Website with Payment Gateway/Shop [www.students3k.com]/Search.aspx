<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Search.aspx.vb" Inherits="Search" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<body>
    <form id="form1" runat="server">
		...
		<a href="#"><img src="images/name.jpg" alt="" width="396" height="117" /></a><img src="images/pic1.jpg" alt="" height="117" style="width: 360px" />
            <asp:ImageButton
                        ID="ImageButton18" runat="server" ImageUrl="~/images/button2.gif" Width="127px" style="z-index: 100; left: 632px; position: absolute; top: 400px" Visible="False" /><br />
	...
	<div id="content" language="javascript" onclick="return content_onclick()">
		...
		<div class="right">
            ...
            &nbsp;
            <asp:Button ID="Button1" runat="server" Text="Search Now !" Width="102px" /><br />
		<br />
			...
			<div class="item">
				...
				<div>
                   ...
                   <asp:Label ID="lbl3" runat="server" Text="Label" Font-Bold="True" ForeColor="Red"></asp:Label><a href="#"></a>&nbsp;<a href="#"></a>
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/button1.gif" ToolTip="This item is being added to cart" /><asp:ImageButton
