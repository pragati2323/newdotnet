...
Partial Class Motors
    ...
    Public Sub data(ByVal num As Integer)
        ...
        sql = "select top 8 * from item where code Not in(select top(" & num & ") code from item where category='Motors' order by code)and category='Motors' order by code"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        conn.Open()
        Dim sql = "select count(*) from item where category='Motors'"
